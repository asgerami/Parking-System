    ...
    try:
        while True:
            ...
            if ch == 1:
                no = True
                while no == True:
                    Vno = input("\tEnter vehicle number (XX-XXXXX) - ").upper()
                    if Vno == "":
                ...
                print(
                    "----------------------------------------------------------------------------------------------------------------------")
                print("*1.Bicycle      3 Birr / Hour")
                print("*2.Bike         5 Birr / Hour")
                print("*3.Car          10 Birr / Hour")
                print(
                    "----------------------------------------------------------------------------------------------------------------------")
            elif ch == 6:
                print(
                ...
                no = True
                while no == True:
                    Vno = input("\tEnter vehicle number to Delete(XX-XXXXX) - ").upper()
                    if Vno == "":
                        print("###### Enter Vehicle No. ######")
                    elif len(Vno) == 12:
                        if Vno in Vehicle_Number:
